...
ActiveRecord::Schema.define(version: 2022_06_30_203012) do
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["artwork_id", "likes_id", "user_id"], name: "index_likes_on_artwork_id_and_likes_id_and_user_id", unique: true
    t.index ["artwork_id", "likes_id"], name: "index_likes_on_artwork_id_and_likes_id"
